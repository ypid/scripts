...
class CdCatDatabase:
    ...
    def convert(self):
        ...
        root.append(etree.Comment(
            " CD Catalog Database file, generated by {}".format(os.path.basename(__file__)) +
            "Homepage: <a href=\"http://cdcat.sf.net\">http://cdcat.sf.net</a>  Author: Christoph Thielecke  (crissi99@gmx.de)" +
            "Program-Version: UNICODE 1.8, Database-Version: 2.1"
        ))
